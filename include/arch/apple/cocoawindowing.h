...
namespace Key {
    ...
    static const Keys All[] = {
		KEY_NONE,
		KEY_A, KEY_B, KEY_C, KEY_D, KEY_E, KEY_F, KEY_G, KEY_H, KEY_I, KEY_J, KEY_K, KEY_L, KEY_M, KEY_N, KEY_O, KEY_P, KEY_Q, KEY_R, KEY_S, KEY_T, KEY_U, KEY_V, KEY_W, KEY_X, KEY_Y, KEY_Z,
		KEY_0, KEY_1, KEY_2, KEY_3, KEY_4, KEY_5, KEY_6, KEY_7, KEY_8, KEY_9,
		KEY_F1_, KEY_F2_, KEY_F3_, KEY_F4_, KEY_F5_, KEY_F6_, KEY_F7_, KEY_F8_, KEY_F9_, KEY_F10_, KEY_F11_, KEY_F12_,
		KEY_UP_, KEY_DOWN_, KEY_LEFT_, KEY_RIGHT_, KEY_SPACE, KEY_TAB,
		KEY_INSERT_, KEY_DEL_, KEY_HOME_, KEY_END_, KEY_PGUP_, KEY_PGDN_,
		KEY_DELETE, KEY_ESCAPE, KEY_RETURN, KEY_ENTER, KEY_PAUSE_, KEY_SCROLL_
	};
}
